...
LAUNCHER_APPID="org.NitindytClient.NitindytClient"
...
if command -v "inkscape" && command -v "icotool" && command -v "oxipng"; then
    ...
    svg2png ${LAUNCHER_APPID}.svg "$d/NitindytClient_16.png" 16 16
    svg2png ${LAUNCHER_APPID}.svg "$d/NitindytClient_24.png" 24 24
    svg2png ${LAUNCHER_APPID}.svg "$d/NitindytClient_32.png" 32 32
    svg2png ${LAUNCHER_APPID}.svg "$d/NitindytClient_48.png" 48 48
    svg2png ${LAUNCHER_APPID}.svg "$d/NitindytClient_64.png" 64 64
    svg2png ${LAUNCHER_APPID}.svg "$d/NitindytClient_128.png" 128 128
    svg2png ${LAUNCHER_APPID}.svg "$d/NitindytClient_256.png" 256 256

    oxipng --opt max --strip all --alpha --interlace 0 "$d/NitindytClient_"*".png"

    rm NitindytClient.ico && icotool -o NitindytClient.ico -c \
        "$d/NitindytClient_256.png"  \
        "$d/NitindytClient_128.png"  \
        "$d/NitindytClient_64.png"   \
        "$d/NitindytClient_48.png"   \
        "$d/NitindytClient_32.png"   \
        "$d/NitindytClient_24.png"   \
        "$d/NitindytClient_16.png"
else
