    ...
    for (auto& url : urls) {
        ...
        if (!url.isLocalFile()) {  // download the remote resource and identify
            ...
            if (url.scheme() == "curseforge" || (url.scheme() == BuildConfig.LAUNCHER_APP_BINARY_NAME && url.host() == "install")) {
                ...
                // NITINDYT CLIENT URL protocol modpack import
                // preferred import format: nitindyt-client://import?url=ENCODED
                // alternative import format: nitindyt-client://import/ENCODED
...
void MainWindow::globalSettingsClosed()
{
    ...
    // but NITINDYT CLIENT LAUNCHER exits abnormally, causing the window state to never be saved:
